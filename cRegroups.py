...
def cal_regroups(
    ...
    for factor in factors:
        ...
        factor_exposure_df = lib_reader.read_by_conditions(
            conditions=[
    ...
    # align exposure
    merged_df = pd.merge(
        left=bridge_df, right=factors_exposure_df, left_on="exposure_dates", right_on="trade_date", how="right"
    )
